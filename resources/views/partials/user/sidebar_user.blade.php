<div class="position-fixed top-0 start-0 text-black d-flex flex-column justify-between"
    ...
    <nav class="flex-grow-1 mt-4 d-flex flex-column gap-3">
        <a href="{{ route('user.dashboard') }}" class="d-flex align-items-center gap-3 py-2 px-3 text-decoration-none text-dark hover-effect">
            <img src="{{ asset('assets/dashboard.png') }}" alt="Dashboard" style="width: 1.5rem; height: 1.5rem;">
            <span>Dashboard</span>
        </a>
        <a href="{{ route('user.rapat') }}" class="d-flex align-items-center gap-3 py-2 px-3 text-decoration-none text-dark hover-effect">
